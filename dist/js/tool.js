...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('locale-anywhere-dropdown', __webpack_require__(5));
    Vue.component('index-locale-anywhere', __webpack_require__(16));
    Vue.component('detail-locale-anywhere', __webpack_require__(17));
    Vue.component('form-locale-anywhere', __webpack_require__(18));

    if (window.config.customDetailToolbar) {
        Vue.component('custom-detail-toolbar', __webpack_require__(28));
    }
});
...
var update = __webpack_require__(2)("5d486d99", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ef782e08\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Dropdown.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ef782e08\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Dropdown.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		...
		Nova.request().get("/nova-vendor/locale-anywhere/languages").then(function (response) {
	...
	methods: {
		switchLocale: function switchLocale(locale) {
			Nova.request().post("/nova-vendor/locale-anywhere/cache-locale", {
				locale: locale
	...
	computed: {
		...
		currentLocaleName: function currentLocaleName() {
			...
			Object.keys(this.locales).forEach(function (locale) {
				if (locale === window.config.locale) {
					name = _this2.locales[locale];
				}
			});
...
var render = function() {
  ...
  return _c(
    "dropdown",
    {
      staticClass: "ml-5 h-9 flex items-center dropdown-right",
      scopedSlots: _vm._u([
        {
          key: "default",
          fn: function(ref) {
        ...
        [
          _c(
            ...
            _vm._l(_vm.locales, function(language, locale) {
              return _c("li", { key: locale, attrs: { data: locale } }, [
                _c(
                  "a",
                  {
                    staticClass:
                      "block no-underline text-90 hover:bg-30 p-3 cursor-pointer",
                    on: {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Locale Anywhere")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-components/LocaleAnywhere/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
   ...
   */
	...
	computed: {
		currentLocaleName: function currentLocaleName() {
			...
			Object.keys(this.field.locales).forEach(function (locale) {
				if (locale === _this.field.locale) {
					name = _this.field.locales[locale];
				}
			});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _vm.resourceId !== undefined
          ? _c(
              "div",
              {
                staticClass: "border-t-4 rounded-b px-4 py-3 mb-2 shadow-md",
                class: {
                  "border-success": _vm.field.value.isTranslated,
                  "border-danger": !_vm.field.value.isTranslated
                },
                attrs: { role: "alert" }
              },
              [
                _c("div", { staticClass: "flex" }, [
                  _c(
                    "div",
                    {
                      staticClass: "py-1",
                      class: {
                        "text-success": _vm.field.value.isTranslated,
                        "text-danger": !_vm.field.value.isTranslated
                      }
                    },
                    [
                      _c(
                  ...
                  _c("div", [
                    _c(
                      ...
                      [
                        _vm._v("\n\t\t\t\t\t\tStatus:\n\t\t\t\t\t\t"),
                        _vm.field.value.isTranslated
                          ? _c("span", [
                              _vm._v("\n\t\t\t\t\t\t\tTRANSLATED\n\t\t\t\t\t\t")
                            ])
                          : _c("span", [_vm._v("NOT TRANSLATED")])
                      ]
                    ),
                    _vm._v(" "),
                    _vm.field.value.isTranslated
                      ? _c("p", { staticClass: "text-sm" }, [
                          ...
                          _c("strong", [_vm._v(_vm._s(_vm.currentLocaleName))]),
                          _vm._v(
          ...
          : _c("div", [
              _c("input", {
                ...
                domProps: {
                  value: _vm.currentLocaleName + " (" + _vm.field.locale + ")"
                }
              })
            ])
      ])
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: {
		...
		label: function label() {
			return this.field.value.isTranslated == true ? this.__("Yes") : this.__("No");
		}
	}
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("panel-item", { attrs: { field: _vm.field } }, [
        _c("div", { attrs: { slot: "value" }, slot: "value" }, [
          _vm._v(
            _vm._s(_vm.currentLocaleName) +
              " (" +
              _vm._s(_vm.field.locale) +
              ")"
          )
        ])
      ]),
      ...
      _c("div", { staticClass: "flex border-b border-40" }, [
        _vm._m(0),
        _vm._v(" "),
        _c("div", { staticClass: "w-3/4 py-4 flex" }, [
          _c("div", [
            _c("span", {
              staticClass: "inline-block rounded-full w-2 h-2 mr-1",
              class: {
                "bg-success": _vm.field.value.isTranslated,
                "bg-danger": !_vm.field.value.isTranslated
              }
            }),
            _vm._v(" "),
          ...
          _vm.field.value.isTranslated
            ? _c(
                ...
                {
                  staticClass:
                    "btn btn-link dim text-80 ml-auto cursor-pointer",
                  on: {
                    click: function($event) {
                      $event.preventDefault()
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	components: {
		"delete-toolbar-button": __webpack_require__(31)
	},

	computed: {
		canDeleteTranslations: function canDeleteTranslations() {
			var can = false;

			this.resource.fields.forEach(function (field) {
...
Component.options.__file = "resources/js/components/DeleteToolbarButton.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6edf8b87", Component.options)
  } else {
    hotAPI.reload("data-v-6edf8b87", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
   ...
   */
		...
		confirmDelete: function confirmDelete() {
			...
			Nova.request().post("/nova-vendor/locale-anywhere/delete?resourceId=" + this.resourceId + "&resourceName=" + this.resourceName, {
				_method: "DELETE"
			}).then(function (response) {
				_this.$toasted.show(_this.__("The translation was deleted!"), { type: "success" });
  ...
  return _c(
    ...
    [
      _c(
        "button",
        {
          staticClass: "btn btn-default btn-icon btn-white text-80",
          attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6edf8b87", module.exports)
  }
}
